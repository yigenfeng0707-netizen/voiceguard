...
echo.
echo  ------------------------------------------------------------------------
echo  [1/3] Running E2E Pipeline (NPU ASR + Rules Engine)...
echo  ------------------------------------------------------------------------
echo  Input: demo_finance_violation.wav (56.4s)
...
echo.
echo  ------------------------------------------------------------------------
echo  [2/3] Opening Quality Inspection Report...
echo  ------------------------------------------------------------------------
...
echo   LLM Review:   29.76s (batch=10) / 20.8s (Ollama GPU Vulkan)
echo   Token Saving: 100%% (0 API tokens)
echo.
...
echo  ------------------------------------------------------------------------
echo.
echo  Demo complete. Closing in 10 seconds...
